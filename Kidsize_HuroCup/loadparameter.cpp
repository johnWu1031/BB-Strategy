...
void LoadParameter::LoadParameters()
{
    ...
    try//計算機器人的身高
    {
        ...
        BasketInfo->RobotHeight1 = cos(BasketInfo->theta1 * Rad) * L_Calf; 
        BasketInfo->RobotHeight2 = cos((BasketInfo->theta2 - BasketInfo->theta1) * Rad) * L_Thigh; 
        BasketInfo->RobotHeight3 = cos((BasketInfo->theta3 + L_BodyError - BasketInfo->theta2 + BasketInfo->theta1) * Rad) * L_Body; 
    ...
    strcpy(path_continuous, path_continuous.c_str());
...
void LoadParameter::TestParameters()
{
    ...
    ROS_INFO("Head = %d",BasketInfo->Head);
    ...
    ROS_INFO("BasketVerticalMaxAngle = %d",BasketInfo->BasketVerticalMaxAngle);
    ROS_INFO("BasketVerticalMinAngle = %d",BasketInfo->BasketVerticalMinAngle);
